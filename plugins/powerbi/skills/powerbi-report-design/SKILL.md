...
| `references/layout.md` | **Read before** placing visuals on canvas — 8-px grid, composition templates, performance considerations |
| `references/cards-and-kpis.md` | **Read before** configuring a KPI/card visual — targets, gaps, trend, display units, icons |
