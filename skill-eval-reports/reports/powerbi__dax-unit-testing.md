...
**Skill Name:** `dax-unit-testing`
**Evaluation Date:** 2026-09-11 21:25:14
...
|-----------|-------|--------|
| **Security** | -50.0/100 | 35% |
| **Quality** | 94.0/100 | 25% |
| **Utility** | 90.0/100 | 20% |
| **Compliance** | 98.0/100 | 20% |
| **Overall** | **43.6/100** | **100%** |

### Key Findings

- ⚠️ **20 HIGH-risk security issues** identified
...
- **Command Injection** in `assets\scripts\generate_measure_tests.py:41`
  - compile() with external code

- **Command Injection** in `assets\scripts\_registry_common.py:75`
  - compile() with external code

- **Command Injection** in `assets\scripts\_registry_common.py:77`
  - compile() with external code

- **Command Injection** in `assets\scripts\_registry_common.py:207`
  - compile() with external code

- **Command Injection** in `assets\scripts\_registry_common.py:258`
  - compile() with external code

#### Medium-Risk Issues (7 found)
...
- Fix Arbitrary File Ops: Validate file paths and use temporary directories for untrusted operations.
