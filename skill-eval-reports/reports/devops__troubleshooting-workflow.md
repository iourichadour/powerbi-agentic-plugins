...
**Skill Name:** `troubleshooting-workflow`
...
| **Compliance** | 94.0/100 | 20% |
| **Overall** | **98.3/100** | **100%** |
...
- Asset repo-memory-convention.template.md is markdown - should be in references/
- Asset TROUBLESHOOTING.template.md is markdown - should be in references/
