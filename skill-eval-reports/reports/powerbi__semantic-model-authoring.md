...
**Skill Name:** `semantic-model-authoring`
**Evaluation Date:** 2026-09-11 21:25:17
...
| **Quality** | 95.0/100 | 25% |
| **Utility** | 85.0/100 | 20% |
| **Compliance** | 90.0/100 | 20% |
| **Overall** | **93.8/100** | **100%** |
...
- Reference dax-perf-decision-guide.md contains code - should be in scripts/
