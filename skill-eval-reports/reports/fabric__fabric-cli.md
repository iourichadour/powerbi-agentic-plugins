...
| **Compliance** | 80.0/100 | 20% |
| **Overall** | **95.2/100** | **100%** |
...
- Reference create-workspaces.md is too short - consider merging into SKILL.md
- Asset dataflow-definition.md is markdown - should be in references/
- Asset lakehouse-definition.md is markdown - should be in references/
- Asset notebook-definition.md is markdown - should be in references/
- Asset report-agent-instructions.md is markdown - should be in references/
- Asset report-definition.md is markdown - should be in references/
- Asset semantic-model-definition.md is markdown - should be in references/
- Excessive second-person language (11 instances) - use imperative form
- Uses second-person language - should use imperative/infinitive form
